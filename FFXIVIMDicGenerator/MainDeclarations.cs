...
"https://raw.githubusercontent.com/thewakingsands/ffxiv-datamining-cn/master/Stain.csv",
        ...
        private readonly Dictionary<string, string> fileTypeNames = new Dictionary<string, string>
        {
            ...
            { "ClassJob.csv", "职业" },
            { "ContentFinderCondition.csv", "副本名称" },
            { "CraftAction.csv", "生产技能" },
            { "Emote.csv", "情感动作" },
            { "ENpcResident.csv", "NPC名称 (大数据)" },
            { "GeneralAction.csv", "共通技能" },
            { "Item.csv", "道具 (大数据)" },
            { "ItemSearchCategory.csv", "道具搜索分类" },
            { "GrandCompany.csv", "所属大国防联军" },
            { "Mount.csv", "坐骑" },
            { "Pet.csv", "召唤兽" },
            { "PlaceName.csv", "地名" },
            { "Quest.csv", "任务 (大数据)" },
            ...
            { "BannerTimeline.csv", "肖像动作 (不含情感动作)" },
            { "BeastReputationRank.csv", "友好部族等级" },
            { "BeastTribe.csv", "友好部族" },
            { "BuddyAction.csv", "陆行鸟(搭档)指令" },
            ...
            { "CharaCardPlayStyle.csv", "游戏风格 (个人信息)" },
            ...
            { "DynamicEvent.csv", "博兹雅/高原CE" },
            { "DynamicEventEnemyType.csv", "博兹雅/高原CE敌人类型" },
